...
These were also stored and rendered on the page . Then , I intercept the request and modified the message parameter with the following XSS payload: <script>alert(“xss”)</script>
